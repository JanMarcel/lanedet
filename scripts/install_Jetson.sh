...
pip3 install pathos addict yapf mmcv mmcv-full imgaug albumentations scikit-learn p_tqdm
pip3 install cycler==0.10 kiwisolver==1.0.1 pyparsing==2.2.1 python-dateutil==2.7.3 opencv-python-headless==4.8.0.74 scipy==1.10.1 imageio==2.3.0 six networkx==2.0 tifffile==2019.7.26 joblib==0.11 threadpoolctl==2.0.0 pytz==2017.3 numpy==1.24.4 attrs==18.1.0
